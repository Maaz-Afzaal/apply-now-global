...
const CountryPage=()=>{
    ...
    const [studentLife,setStudentLife]=useState([
        ...
        {
            heading:"Student Accommodation in the UK",
            content:[
        ...
        {
            heading:"Typical Monthly Costs in the UK",
            list:[
            ...
            heading:"Work and Study in the UK",
            content:[
    ...
    return(
        <div className="countryPage">
            ...
            <div className="countryPageBody">
                <div className="tabs  ">
                    <div className={`col-3 ${(activeTab===1)?"active":""}`} onClick={()=>{setActiveTab(1)}}>
                        Student Life In {countryName}
                    </div>
                    <div className={`col-3 ${(activeTab===2)?"active":""}`}>
                        Scholarships {'&'} Funding
                    </div>
                    <div className={`col-3 ${(activeTab===3)?"active":""}`}>
